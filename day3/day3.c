...
Point* line_intersection(Line line1, Line line2) {
    int xa = (line2.first.y - line2.second.y) * (line1.first.x - line2.first.x) + (line2.second.x - line2.first.x) * (line1.first.y - line2.first.y);
    int xb = (line2.second.x - line2.first.x) * (line1.first.y - line1.second.y) - (line1.first.x - line1.second.x) * (line2.second.y - line2.first.y);

    int ya = (line1.first.y - line1.second.y) * (line1.first.x - line2.first.x) + (line1.second.x - line1.first.x) * (line1.first.y - line2.first.y);
    int yb = (line2.second.x - line2.first.x) * (line1.first.y - line1.second.y) - (line1.first.x - line1.second.x) * (line2.second.y - line2.first.y);
